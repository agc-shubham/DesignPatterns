...
<img src="./resources/strategy.png" alt="Strategy Image" width="400"/>
...
<img src="./resources/command.png" alt="Command Image" width="400"/>

### Observer: 
> Allows an object notify other objects when its state changes.

<img src="./resources/observer.png" alt="Observer Image" width="400"/>

### Mediator: 
> Allows an object to encapsulate the communication between other objects.

<img src="./resources/mediator.png" alt="Mediator Image" width="400"/>

### Chain of Responsibility: 
> Allows building a chain of objects to process a request.

<img src="./resources/chainofresp.png" alt="Chain of Responsibility Image" width="400"/>

### Visitor: 
> Allows adding new operations to an object structure without modifying it.

<img src="./resources/visitor.png" alt="Visitor Image" width="400"/>